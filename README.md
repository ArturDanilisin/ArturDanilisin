...
[data-bs-theme=light] {
  ...
  --bs-link-color-rgb: 254, 192, 7;
  --bs-link-decoration: underline;
  --bs-link-hover-color: #0a58ca;
  --bs-link-hover-color-rgb: 255, 202, 44;
...
.form-control:focus {
  ...
  box-shadow: 0 13px 27px rgb(255 255 255 / 10%);
}
...
.nav-tabs .nav-link {
  ...
  background: none;
  border: var(--bs-nav-tabs-border-width) solid rgba(255, 255, 255, 0.1);
